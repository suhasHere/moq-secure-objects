...
runs over. MoQT support different E2EE protection as well as allowing for
E2EE security.
...
Objects are comprised of two parts: envelope and a payload. The envelope is
...
TrackNamespace and TrackName are treated as a sequence of binary bytes.
Group and Objects are represented as variable length integers called GroupId and
ObjectId respectively.
...
This document defines an encryption mechanism, called Secure Object(SecObj),
...
AEAD_NONCE_SIZE: The size in bytes of a nonce for the encryption algorithm
...
other reason, the client MUST discard the ciphertext. Invalid ciphertext SHOULD be
